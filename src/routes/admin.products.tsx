    ...
    <div className="p-6 md:p-10">
      ...
      <div className="rounded-3xl border border-gold/20 bg-card p-12 grid place-items-center text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-md">
          Le CRUD complet pour ce module (création, édition, suppression, upload d'images) sera ajouté à la prochaine itération.
          Les tables et règles d'accès sont déjà en place côté base de données.
        </p>
      </div>
    </div>
  );
...
export const Route = createFileRoute("/admin/products")({ component: () => <ComingSoon title="Produits" /> });
