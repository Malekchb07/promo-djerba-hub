...
export const Route = createFileRoute("/admin/coupons")({
  component: () => (
    <div className="p-6 md:p-10">
      <h1 className="font-display text-3xl md:text-4xl mb-2">Coupons</h1>
      ...
      <div className="rounded-3xl border border-gold/20 bg-card p-12 grid place-items-center text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-md">Création, QR codes, limites d'usage et historique — à venir.</p>
      </div>
    </div>
  ),
});
